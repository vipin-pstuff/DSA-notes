...
- inverted left half pyramid
    - so for 1st row , we're printing 4 stars , so formula is `(n - row) + 1` 
        ![getting output based on this formula](../../notes-pics/12-lecture/lecture-12-2.png)
        ![3 things which are important to find the star count](../../notes-pics/12-lecture/lecture-12-3.png)
    - so that's why based on this , we can make a formula i. `(n - row) + 1`
        ![calculating whether we're getting correct answer via this formula equalto our stars on each row](../../notes-pics/12-lecture/lecture-12-4.png)
    - `Note ✅` : here in formula , why we took `+ 1` because we run `row from 1 to n` but if we run row from 0 to n <br>
        ...
        ![why we took + 1 in formula](../../notes-pics/12-lecture/lecture-12-5.png)
    - but if you don't want to apply this formula , then you can use counter so on each row counter is decrementing like this 
        ![another way to solve this pattern](../../notes-pics/12-lecture/lecture-12-6.png) 
        - so we can run logic for `row` based on `n` like this 
        ![another way to solve this pattern](../../notes-pics/12-lecture/lecture-12-7.png) 
    ```cpp
    #include <iostream>
    using namespace std;
...
- right half pattern 
    ...
    * * * * * 
    ...
    - so from 1st to 3rd row , we're printing two things in each row i.e space & star , <br>
        ...
        ![understanding the concept to solve this pattern](../../notes-pics/12-lecture/lecture-12-8.png)
        ![understanding the concept to solve this pattern](../../notes-pics/12-lecture/lecture-12-9.png)
        ![understanding the concept to solve this pattern](../../notes-pics/12-lecture/lecture-12-10.png)
    - so eg : in 1st row , we need 3 spaces , so how you'll make 3 i.e `n = 4` & row is 1st , <br>
        so if we do `n - row` , we'll get `3` like this 💡💡💡 <br>
        ![how you'll make 2 thing in each row except in 4th row](../../notes-pics/12-lecture/lecture-12-11.png)
...
- right inverted half pattern
    ![right inverted half pattern](../../notes-pics/12-lecture/lecture-12-12.png)
    - so previously , we did those triangles pattern <br>
        ![spaces we have](../../notes-pics/12-lecture/lecture-12-13.png)
    - so first count , in 1st row , how much space & stars do you have & same with other rows like this 
        ![count spaces & stars for each row except last row](../../notes-pics/12-lecture/lecture-12-14.png)
    - so we can see that whatever row number is decrementing by `1` to get the spaces , 💡💡💡 <br>
        so space formula is `row - 1` like this <br>
        ![finding formula for spaces](../../notes-pics/12-lecture/lecture-12-15.png)
    - for finding star , we'll have this formula i.e `n - row + 1` like this 💡💡💡 <br>
        ![finding formula for star](../../notes-pics/12-lecture/lecture-12-16.png)
    ```cpp
    #include <iostream>
    using namespace std;
    ...
    - so till yet we saw these patterns
        ![patterns that we didn't till yet](../../notes-pics/12-lecture/lecture-12-17.png)

- homework 
    - print solid diamond pattern like this 
        ![approach to print diamond pattern](../../notes-pics/12-lecture/lecture-12-18.png)
    ...
    - hollow left inverted half pyramid , inverted solid full pyramid , hollow full pyramid
        ![patterns picture](../../notes-pics/12-lecture/lecture-12-19.png)
...
- full solid pyramid
    ...
    - so this pattern , we need to print & it's half part looks like previous pattern i.e right half pattern like this 
        ![patterns that we didn't till yet](../../notes-pics/12-lecture/lecture-12-20.png)
    - approach to make formula , write down all rows , count spaces & starts in each row like this 💡💡🔥
        ![approach to find the formula of a pattern](../../notes-pics/12-lecture/lecture-12-21.png)
    ...
    - so ultimately game lies here i.e finding formula for condition 💡💡💡<br>
        ![approach to find the formula of a pattern](../../notes-pics/12-lecture/lecture-12-22.png)
...
- hollow left inverted half pyramid
    ...
    *
    ...
    - approach to solve hollow left inverted half pyramid 💡💡💡
        ![approach](../../notes-pics/12-lecture/lecture-12-25.png)
        ![code approach](../../notes-pics/12-lecture/lecture-12-26.png)
    - why we're handling that 1st row & last row separately because we're getting that pattern like this 
        ![reason why we're handling first & last row separately](../../notes-pics/12-lecture/lecture-12-27.png)
    ...
    - logic of code 💡💡💡
        ![logic of code](../../notes-pics/12-lecture/lecture-12-28.png)
    - now we need of find out formula 
        - for first row & last row , Eg : we have `row = 1` & `n = 5` & you need to make `5` <br>
            ...
            ![logic of code - for 1st & last row](../../notes-pics/12-lecture/lecture-12-29.png)
        - now for middle , we need to find out formula , Eg : in 2nd row i.e `row = 2` & `n = 5` <br>
            ...
            ![logic of code - for middle pattern](../../notes-pics/12-lecture/lecture-12-30.png)
    ```cpp
    #include <iostream>
    using namespace std;
...
- homework 
    - in first diagram , numbers half left pyramid , we're just printing column number 
        ![numbers pattern](../../notes-pics/12-lecture/lecture-12-31.png)
